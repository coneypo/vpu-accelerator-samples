...
static void ExecuteZeroTermTracking(const std::string& model_path, cv::VideoCapture* capture);
...
const char* kUsageMessage =
    ...
    "An input rectangular coordinate and an frame should be fed for tracking objects.\n"
    "zeroterm_type_tracker [OPTION]\n"
    "Options:";
...
int main(int argc, char** argv)
{
    ...
    ExecuteZeroTermTracking(FLAGS_m, &capture);
